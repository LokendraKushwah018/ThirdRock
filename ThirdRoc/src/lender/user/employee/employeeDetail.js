...
import { GetEmployee } from '../../../lender/service/lenderService';
// import { GetEmployerDetail ,GetEmployee} from '../../service/lenderService';
...
const EmployeeDetail = (props) => {
    ...
    const GetEmployeeData = async (token, id) => {
    ...
    useEffect(() => {
        GetEmployeeData(lender.lender_token, id);
    }, [id]);
                                        ...
                                        <div className="main-contact-info-header bg-contacthead">
                                            <div className="media">
                                                ...
                                                <div className="media-body text-white">
                                                    <h4 className="text-white">Employee Name: {Name}</h4>

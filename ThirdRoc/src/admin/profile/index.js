...
const Profile= (props) => {
    ...
    const getList = (page=1) => {
        setloading(true)
        props.api.getApi('admin/getProfileList',{page:page-1,size:10}).then(response => {
               ...
               <div className="page-header">
                  ...
                  <div className="page-rightheader"> 
				       <div className="btn-list"> 
				          <Link to={props.prefix+'/add-profile'}  className="btn btn-outline-primary"><i className="fa fa-plus me-2"></i> Add Profile</Link> 
                        ...
                        <div className="col-xl-4 col-md-12 col-lg-12" key={index} > 
                            ...
                            <div className="card-body"> 
                                <div className="media mt-0"> 
                                    ...
                                    <Link to={props.prefix+'/edit-profile/'+option.profile_id}  className="btn btn-primary d-none d-sm-block me-2"><i className="fa fa-edit"></i></Link> 
                                </div> 
                            </div>  
                            </div> 
                        </div>

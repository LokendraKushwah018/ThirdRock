...
import { GetEmployee } from '../service/employService';
                                        ...
                                        <div className="main-contact-info-header bg-contacthead">
                                            <div className="media">
                                                ...
                                                <div className="media-body text-white">
                                                    <h4 className="text-white">Employee Name: {"Abhi"}</h4>
                                                    <p className="mb-1">Country : {"India"}</p>
                                                    <p className="">Mobile No. : {"7964529845"}</p>
                                                </div>
                                            </div>
                                            <div className="main-contact-action"> <Link to={process.env.REACT_APP_EMPLOYER_PRIFIX + `/employee_edit/${id}`} className="btn btn-primary"> Edit</Link></div>
                                        </div>
                                                ...
                                                <div className="media py-4 mt-0">
                                                    <div className="media-body">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="w-70"> <label>Mobile no :</label> <span className="font-weight-normal1 fs-14">{employeeDetail ? Mobile : ''}</span> </div>
                                                        </div>
                                                        <div className="d-flex">
                                                ...
                                                <div className="media py-4 border-top mt-0">
                                                    <div className="media-body">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="w-70"> <label>Location :</label> <span className="font-weight-normal1 fs-14">{employeeDetail ? Location : ''}</span> </div>
                                                        </div>
                                                        <div className="d-flex">

...
import {GetDashboard} from '../service/MerchantService';
					...
					<div className="col-xl-3 col-lg-6 col-md-12">
						<div className="card">
							<div className="card-body">
								...
								<span className="mb-1"><Link to={'/merchant/settlement'} className="text-azure"><i className="fa fa-eye  me-1"></i> View Detail</Link></span>
							</div>
						</div>
					</div>
					...
					<div className="col-xl-3 col-lg-6 col-md-12">
						<div className="card">
							<div className="card-body">
								...
								<span className="mb-1"><Link to={'/merchant/store_list'} className="text-azure"><i className="fa fa-eye  me-1"></i> View Detail</Link></span>
							</div>
						</div>
					</div>
					<div className="col-xl-3 col-lg-6 col-md-12">
						<div className="card">
							<div className="card-body">
								...
								<span className="mb-1"><Link to={'/merchant/transctions'} className="text-azure"><i className="fa fa-eye  me-1"></i> View Detail</Link></span>
							</div>
						</div>
					</div>

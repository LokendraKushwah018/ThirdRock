                    ...
                    <div className="col-md-12">
                      ...
                      <div className="row">
                        <div className="media col-md-4">
                          <div className="media-body">
                            <img src={'https://thirdroc1.s3.ap-southeast-2.amazonaws.com/merchant-logo-' + profileData.logo} alt="no logo here" style={{ height: "230px", width: "230px", objectFit: "contain" }} />
                          </div>
                        </div>
                      </div>
                    </div>

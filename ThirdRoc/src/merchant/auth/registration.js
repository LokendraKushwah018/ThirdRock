...
import { MerchantRegistration, GetCountry } from '../service/MerchantService';
...
const Registration = () => {
  ...
  const form = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const response = await MerchantRegistration(formData);
      ...
      if (response.status === true) {
        ...
        navigate(process.env.REACT_APP_MARCHNT_PRIFIX + '/dashboard');
      } else {
                        ...
                        <div class="bg-white text-dark br-7 br-tl-0 br-bl-0">
                          <div class="card-body">
                            <div class="text-center mb-3">
                              <h3 class="mb-2">Register As Merchant</h3>
                            </div>

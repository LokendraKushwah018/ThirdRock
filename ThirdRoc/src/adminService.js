...
class AdminService {   
    getApi(path,parameter = '',object = {}) {
        return new Promise(function(resolve, reject) {
            ...
            let headers = {'Authorization': JSON.parse(adminData)?.admin_token}
    ...
    postApi(path,body={}, is_formData = false,object= {'Authorization': JSON.parse(localStorage.getItem("admin"))?.admin_token } ) {
        return new Promise(function(resolve, reject) {
            let headers = {}
